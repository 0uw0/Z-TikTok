	...
	def get_followers(self):
		...
		while 1:
			...
			try:
				...
				self.err+=1
				if self.err==6:input(grn+'[+] Deleted successfully ✅');exit('By ZyouZ')
				else:pass
...
i Love You 💖 .. Welcome To 7K

###====================================================================================================###

    1- Delete following
2- Delete followers '''));get_ID(M0D)